...
//
//--------------------------------------------------------------------
//Faça um algoritmo, em C, que leia os n elementos de um vetor, ordene-os, e
//informe todos os elementos que se repetem
...
int main(){
    ...
    int vet[] = {25,4,6,7,9,0,1,2,5,8,77,99,4,25,10,38,40,55,20,44,35,38,99,10,65,50};
    ...
    for(i=0; i<(tamVet-1);i++)
        if(vet[i]==vet[i+1])
            printf("Elemento v[%d] é igual ao elemento v[%d] = %d\n",i,i+1,vet[i]);
